...
|---|---|---|
| `InstallerModels-Setup-1.0.1.exe` | обычная установка с ярлыками | ничего |
...
Запусти `InstallerModels-Setup-1.0.1.exe`. Ставится в папку пользователя (`%LOCALAPPDATA%\Programs\InstallerModels`), права администратора не нужны, UAC не выскочит. Создаёт ярлык в меню Пуск, запись в «Программы и компоненты» для нормального удаления и, если не снять галочку, ярлык на рабочем столе. Галочка снимается на странице выбора компонентов.
...
В списке групп галочками отмечаешь, что нужно. Справа от каждой строки написано, установлена группа, частично установлена или нет. Битый или недокачанный файл считается за «частично»: он на диске лежит, и его предстоит докачать, а не качать с нуля. Кнопка «Только недостающие» отмечает всё, чего не хватает.
