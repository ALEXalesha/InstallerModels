...
Всего 41 проверка, за четырьмя из них 2640 порождённых, весь прогон - пять секунд. Проверками накрыты и консоль (коды возврата, разбор команды, установка от начала до конца), и окно (сборка виджетов, насос событий, три исхода закачки), и сама сборка, и `setup.nsi`.
