...
Программа переносится копированием: возьми `dist/InstallerModels-portable-2.0.0.zip` (или папку `dist/app/InstallerModels` целиком) - там exe, `_internal`, `models.json`, `README.md` и `docs`. Python на новой машине не нужен, он внутри. Нужны только Windows и x64. Либо просто поставь там `InstallerModels-Setup`.
